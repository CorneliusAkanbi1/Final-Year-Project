        ...
        if results.pose_landmarks:
            ...
            if abs(angle_23_24_25_26) < angle_threshold:
                ...
                if check_intersection(line1, line2):
                    if not contact_flag and (cTime - last_rep_time) >= 1:  #1 second delay between reps
                        rep_counter += 1  # Increment rep counter
                        contact_flag = True
                        last_rep_time = cTime
                    color = (255, 0, 0)  # Turn the lines blue
                else:
                    contact_flag = False
                    color = (0, 255, 0)  # Lines turn back green
            ...
            # Display the reps count in the top-right corner
